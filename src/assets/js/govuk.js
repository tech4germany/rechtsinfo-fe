...
// Source: https://github.com/alphagov/govuk_publishing_components/blob/master/app/assets/javascripts/govuk_publishing_components/components/modal-dialogue.js
...
function initAll (options) {
  ...
  var $modals = scope.querySelector('[data-module="modal-dialogue"]');
  new ModalDialogue($modals).init();
